class fruits:
    def __init__(self, type, price, color):      #constructor of a class. evrery class should have a constructor
        self.type = type
        self.price = price
        self.color = color
    def onyesha(self):           # a method
        print(f"i like eating {self.type} and it costs {self.price}, color being {self.color}")

# creating an object

myobject = fruits("banana","20 Ksh", "yellow")
myobject2 = fruits(" Mangoes","40 Ksh","Red")
...
# Class: A class is a blueprint or template for creating objects. It defines the attributes (data) and methods (functions) that objects of the class will have. For example, a "Person" class might have attributes like name and age, along with methods like "speak" or "walk."
#
